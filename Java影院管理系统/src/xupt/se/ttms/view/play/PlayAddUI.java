...
public class PlayAddUI {
	...
	public static void main(String[] args) {
		PlayAddUI window = new PlayAddUI();
	...
	protected void btnSaveClicked(){
		if (textField.getText() != null && textField_1.getText() != null && textField_2.getText() != null
			...
			plSrv.addPlay(textField.getText(), textField_1.getText(), textField_2.getText()
	...
	private void initialize() {
		frame = new JFrame("添加剧目");
		frame.setBounds(100, 100, 732, 501);
		frame.setLocationRelativeTo(null);
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		JLabel lblNewLabel = new JLabel("添加剧目");

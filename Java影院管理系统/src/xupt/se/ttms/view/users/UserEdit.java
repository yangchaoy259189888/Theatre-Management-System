		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(string_password.equals("") || string_name.equals("") || string_email.equals("")
					...
					//寻找id
					String string_id = empSrv.employeeBackId(string_name);
					
					String string = empSrv.employeeEditUser(string_id,string_password, string_name, string_email
